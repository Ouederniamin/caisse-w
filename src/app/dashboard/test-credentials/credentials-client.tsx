...
export function CredentialsClient({ user }: CredentialsClientProps) {
  const webCredentials = [
    ...
    },
    {
      ...
      password: "password123",
      role: "Direction",
      description: "Dashboard complet, gestion conflits, validation tournées",
      color: "bg-indigo-500",
      icon: UserCog,
    },
  ];
  ...
  const mobileCredentials = [
    {
      ...
      password: "password123",
      role: "Agent Contrôle",
      description: "Contrôle des caisses au départ et retour des tournées",
      color: "bg-blue-500",
      icon: CheckCircle2,
      permissions: ["Créer tournées", "Compter caisses", "Prendre photos", "Saisir retours"],
    },
    {
      email: "hygiene1@caisse.tn",
      password: "password123",
      role: "Agent Hygiène",
      description: "Contrôle hygiène des véhicules et caisses au retour",
      color: "bg-green-500",
      icon: Sparkles,
      permissions: ["Contrôle hygiène", "Approuver/Rejeter véhicules", "Photos hygiène", "Notes"],
    },
    {
      email: "securite1@caisse.tn",
      password: "password123",
      role: "Sécurité (Pont-bascule)",
    ...
    },
    {
      email: "direction@caisse.tn",
      password: "password123",
      role: "Direction (Mobile)",
      description: "Tableau de bord KPIs, gestion conflits, notifications",
      color: "bg-indigo-500",
      icon: UserCog,
      permissions: ["KPIs temps réel", "Approuver conflits", "Push notifications", "Mode hors-ligne"],
    },
  ];
